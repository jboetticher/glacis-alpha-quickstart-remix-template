...
import {ERC20} from "@openzeppelin/contracts@v4.9/token/ERC20/ERC20.sol";
import {ERC20Permit} from "@openzeppelin/contracts@v4.9/token/ERC20/extensions/draft-ERC20Permit.sol";
import {Ownable} from "@openzeppelin/contracts@v4.9/access/Ownable.sol";
...
contract XERC20Basic is ERC20, Ownable, ERC20Permit, IXERC20 {
    /**
...
contract XERC20 is XERC20Basic {
    /**
     * @notice Constructs the initial config of the XERC20
     *
     * @param _name The name of the token
